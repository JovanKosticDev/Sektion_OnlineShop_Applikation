...
public class SecondCartFragment extends Fragment {
    ...
    private EditText edtTxtAdress, edtTxtZipCode, edtTxtPhoneNumber, edtTxtEmail;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(null != bundle){
            ...
            if(null != jsonOrder){
                ...
                if(null != order){
                    edtTxtAdress.setText(order.getAdress());
                    edtTxtPhoneNumber.setText(order.getPhoneNumber());
                    edtTxtZipCode.setText(order.getEmail());
            ...
            public void onClick(View v) {
                if(validateData()){
                    ...
                    if(null != cartItems){
                        ...
                        order.setAdress(edtTxtAdress.getText().toString());
                    ...
                    txtWarning.setText("Alle Felder müssen ausgefüllt sein");
                }
            }
        });
    ...
    private boolean validateData(){
        if(edtTxtAdress.getText().toString().equals("") || edtTxtPhoneNumber.getText().toString().equals("")||
    ...
    private void initViews(View view){
        edtTxtAdress = view.findViewById(R.id.edtTxtAdresse);
